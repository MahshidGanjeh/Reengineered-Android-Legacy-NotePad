...
import com.example.android.notepad.data.NoteDatabase;
...
public class NotesList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNoteList = NoteDatabase.getUserDatabase(getApplicationContext()).userDao().getNote();
        NoteAdapter adapter = new NoteAdapter();
        adapter.setmNotesList(mNoteList);
